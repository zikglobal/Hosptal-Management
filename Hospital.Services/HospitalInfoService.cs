...
namespace Hospital.Services
{
    public class HospitalInfoService : IHospitalInfo
    {
        ...
        public void DeleteHosipalInfo(int id)
        {
        ...
        public HospitalInfoViewModel GetHositalById(int HospitalId)
        {
        ...
        public void InsertHosipalInfo(HospitalInfoViewModel hospitalInfo)
        {
